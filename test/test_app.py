...
def test_main_menu_choice(monkeypatch, stub_menu_list, handler_list, data_list, stub_menu):
...
def test_main_menu_choice_invalid_input(monkeypatch, capsys, stub_menu_list, handler_list, data_list):
...
def test_main_menu_choice_exit(monkeypatch, stub_menu_list, handler_list, data_list):
    monkeypatch.setattr('sys.stdin', StringIO('0\n'))
    expected = False
    
    assert expected == main_menu_choice(stub_menu_list, handler_list, data_list)
